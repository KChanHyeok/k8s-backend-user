...
public class UserAuthController {
    ...
    public ApiResponseDto<TokenDto.AccessResfreshToken> login(@RequestBody @Valid SiteUserLoginDto siteUserLoginDto) {
        TokenDto.AccessResfreshToken token = siteUserService.login(siteUserLoginDto);
